...
export default function Header() {
	...
	return (
	<div className="flex bg-background justify-between px-10 py-5  cursor-pointer">
		...
		<div className="flex gap-5 items-center ">
			<Link href="/auth/login" className="hover:text-primary" onClick={()=>resetActive()}>Login</Link>
			<Link href="/auth/signup" className="hover:text-primary" onClick={()=>resetActive()}>Signup</Link>
		</div>
