...
export default function Header() {
	...
	return (
	<div className=" sticky top-0 z-50 flex bg-background justify-between px-10 py-5  cursor-pointer">
		...
		<div className="flex gap-5 items-center ">
			<Link href="/auth/login" className="hover:text-primary hover:bg-secondary outline outline-1 outline-primary rounded-sm p-btn-default " onClick={()=>resetActive()}>Login</Link>
			<Link href="/auth/signup" className="hover:text-secondary text-background bg-primary rounded-sm p-btn-default" onClick={()=>resetActive()}>Signup</Link>
		</div>
